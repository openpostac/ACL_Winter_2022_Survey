...
#new dataset dat2 with all the previous data plus a recoded variable for each the sector and role info. 
dat2 <- dat %>% 
  mutate(
    my_sector =  
      recode(sector_my,
...
```{r Xtabs for Sector }
#Run the function for Xtabs for each of the multiple select variables - Sector  
